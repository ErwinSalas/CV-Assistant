...
import dev.edmt.androidcamerarecognitiontext.DataProviders.GetTokenTask;

public class LabelRecognizerActivity extends AppCompatActivity {
    ...
    private final String LOG_TAG = "LabelRecognizerActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_label_recognizer);
        ...
        selectImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(LabelRecognizerActivity.this,
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(LabelRecognizerActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    private void getAuthToken() {
        ...
        if (mAccount == null) {
            ...
            new GetTokenTask(LabelRecognizerActivity.this, mAccount, SCOPE, REQUEST_ACCOUNT_AUTHORIZATION)
                    .execute();
        }
    }
